...
type ConnectionDashboardUploadDrawerProps = {
  isOpen: boolean;
  onClose: () => void;
  onUpload: (encodedJson: string) => string | undefined;
};

const ConnectionDashboardUploadDrawer: FunctionComponent<ConnectionDashboardUploadDrawerProps> = ({
  isOpen,
  onClose,
  onUpload,
}) => {
...
export default ConnectionDashboardUploadDrawer;
